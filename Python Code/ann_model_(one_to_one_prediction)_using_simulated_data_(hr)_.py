# -*- coding: utf-8 -*-
"""ANN Model (One-to-One Prediction) - Using Simulated Data (HR) .ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1KH1fRdreQc_YtdIzv3t_0YwAwih1DxEn
...
simulated_data_file_path = os.path.join(csv_folder_path, "simulated_data.csv")

# FILTERING THE DATA
colnames=['TIME', 'HR'] 
# user1 = pd.read_csv('dataset/1.csv', names=colnames, header=None)
df = pd.read_csv(simulated_data_file_path, names=colnames,header=None, index_col=False, error_bad_lines=False , usecols=[ 'HR'] )
